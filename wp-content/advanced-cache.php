...
if ( ! @file_exists( 'D:\eos\jsvc\wp-content\plugins\breeze/breeze.php' ) ) { return; }
$config['config_path'] = 'D:\eos\jsvc/wp-content/breeze-config/breeze-config.php';
...
if ( @file_exists( 'D:\eos\jsvc\wp-content\plugins\breeze/inc/cache/execute-cache.php' ) ) {
	include_once 'D:\eos\jsvc\wp-content\plugins\breeze/inc/cache/execute-cache.php';
}
